...
export class FirstTestimoniesComponent {
  @Output()  testimonies = [
    {
      relate: 
      `Os serviços de avaliação física e acompanhamento da xHealth me ajudaram imensamente no processo de perder peso e entender melhor quais treinos deveria fazer para melhorar minha rotina e disiciplina comigo mesma. Uso e recomendo imensamente!`,
      name: 'Sofia Garcia',
    ...
    {
        relate: 
        `A xHealth tem tudo aquilo que um atleta precisa se deseja ingressar no mundo profissional. As metodologias de ensino e revezamento de reinos, somados com a estrutura impecável, tornam ela o melhor lugar para se formar como um esportista profissional.`,
